...
from tools.nuScenes_lib.utils_kitti import KittiDB
...
from tools.nuScenes_lib.utils_radar import map_pointcloud_to_image
import time

DATA_PATH = '../data/nuscenes/'
OUT_PATH = DATA_PATH + 'annotations'

USING_MINI_NUSCENES = True
if USING_MINI_NUSCENES:
  print("Using mini nuScenes dataset only")
  SPLITS = {
    'mini_val': 'v1.0-mini',
    'mini_train': 'v1.0-mini',
  }
else:
  print("Using full nuScenes dataset")
  SPLITS = {
          'mini_val': 'v1.0-mini',
          'mini_train': 'v1.0-mini',
          'train': 'v1.0-trainval',
